    ...
    <div className="min-h-screen bg-stone-50" style={fontStyle}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <FeatureCard 
              ...
              description="Access templates, guides, and tools used by successful founders—from legal docs to marketing playbooks."
            />
            <FeatureCard 
      ...
      <footer className="border-t border-stone-200 py-12 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-stone-400 text-xs">© 2025 Astriva · Built by a teen, for teens</p>
        </div>
      </footer>
